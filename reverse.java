...
public class reverse {
    ...
    // public static String path = "/data/user/0/com.mobisec.dexclassloader/code_cache/test.dex";
    public static String path = "test.dex";
    ...
    public static void da(String path){
        ...
        try{
            ...
            // Alternatively, you can print the file path directly
